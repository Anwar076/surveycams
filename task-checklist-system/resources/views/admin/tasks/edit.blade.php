...
<div class="space-y-6">
    ...
    <div class="bg-white shadow rounded-lg p-6">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Update "{{ $task->title }}" in "{{ $task->taskList->title }}"</p>
            </div>
    ...
    <div class="bg-white shadow rounded-lg border border-red-200">
        ...
        <div class="p-6">
            <div class="flex justify-between items-center">
                <div>
                    <h4 class="text-sm font-medium text-red-900">Delete Task</h4>
                    <p class="text-sm text-red-700">Once you delete this task, there is no going back. This will also delete all associated submissions for this task.</p>
                </div>
                <form method="POST" action="{{ route('admin.tasks.destroy', $task) }}" onsubmit="return confirm('Are you sure you want to delete this task? This action cannot be undone.')">
                    @csrf
                    @method('DELETE')
