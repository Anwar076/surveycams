        ...
        <form method="POST" action="{{ route('admin.lists.tasks.store', $list) }}" class="space-y-6 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="order_index" id="order_index" min="1" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" value="{{ old('order_index', $list->tasks->count() + 1) }}" placeholder="1">
